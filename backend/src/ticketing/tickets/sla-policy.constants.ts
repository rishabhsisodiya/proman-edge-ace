 ...
 *
 * Typed as string (2026-08-02, Service Types Tier 1) — was `ServiceType[]`;
 * Ticket.serviceType itself is now a plain string, and these 3 fixed system
 * types happen to still be among the original 8 seeded ServiceTypeConfig
 * codes, so nothing else changes here.
 */
export const SLA_TARGET_DATE_SERVICE_TYPES: string[] = ['SCHEDULED_PM', 'TECHNICAL_AUDIT', 'RETROFIT_UPGRADE'];
export const SLA_TARGET_DATE_LABEL: Partial<Record<string, string>> = {
